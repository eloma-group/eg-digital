...
const COLS: { heading: string; links: string[] }[] = [
  ...
  { heading: 'Services',   links: [
      'Web Development','Mobile App Development','SEO Services','Technical SEO','Local SEO','Off-Page SEO','PPC Services','Google Ads','Facebook Ads','Social Media Marketing','Microsoft Solutions',
